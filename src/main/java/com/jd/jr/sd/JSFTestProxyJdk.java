 ...
 *  
 */
public class JSFTestProxyJdk {
	private static Logger logger = LoggerFactory.getLogger(JSFTestProxyJdk.class);
	...
	public static void setUpBeforeClass() {
		context = new ClassPathXmlApplicationContext("main-jsf-proxy-jdk.xml");
