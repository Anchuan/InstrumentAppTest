 ...
 *  
 */
public class JSFTestProxyJavassist {
	private static Logger logger = LoggerFactory.getLogger(JSFTestProxyJavassist.class);
	...
	public static void setUpBeforeClass() {
		context = new ClassPathXmlApplicationContext("main-jsf-proxy-javassist.xml");
